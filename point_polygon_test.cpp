...
void run_point_polygon_test() {
	...
	cv::Point p4 = cv::Point(300, 300);	// Point(301, 300) is at the low corner of our rectangle
										// Point(304, 304) should return a distance of 5 -> the hypotenuse
	...
	double pythagoras = cv::pointPolygonTest(contours[0], p4, true);
	...
	std::cout << "Return value for point (" << p4.x << ", " << p4.y << "): " << pythagoras << std::endl;
